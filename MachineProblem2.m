...
A=[p1(1) p1(2) 1; p2(1) p2(2) 1; p3(1) p3(2) 1]; %coefficients of variables of x and y
...
E=C(2);
F=C(3);
h=-D/2;k=-E/2; %get h, k values using formula
radius=sqrt((D^2+E^2-4*F)/(4)); % get radius using formula
